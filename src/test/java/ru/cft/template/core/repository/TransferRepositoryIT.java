...
public class TransferRepositoryIT {
    ...
    public List<Wallet> preparedWallets = WalletRepositoryIT.preparedWallets;
    public List<Transfer> preparedTransfers = List.of(
            Transfer.builder()
                    .id(1L)
                    .senderWallet(this.preparedWallets.get(0))
                    .recipientWallet(this.preparedWallets.get(1))
                    .amount(50L)
                    .status(TransferStatus.SUCCESSFUL)
                    .build(),
            Transfer.builder()
                    .id(2L)
                    .senderWallet(this.preparedWallets.get(2))
                    .recipientWallet(this.preparedWallets.get(3))
                    .amount(20L)
                    .status(TransferStatus.FAILED)
                    .build(),
            Transfer.builder()
                    .id(3L)
                    .senderWallet(this.preparedWallets.get(1))
                    .recipientWallet(this.preparedWallets.get(0))
                    .amount(75L)
                    .status(TransferStatus.SUCCESSFUL)
                    .build(),
            Transfer.builder()
                    .id(4L)
                    .senderWallet(this.preparedWallets.get(3))
                    .recipientWallet(this.preparedWallets.get(4))
                    .amount(10L)
                    .status(TransferStatus.SUCCESSFUL)
                    .build(),
            Transfer.builder()
                    .id(5L)
                    .senderWallet(this.preparedWallets.get(4))
                    .recipientWallet(this.preparedWallets.get(0))
                    .amount(30L)
                    .status(TransferStatus.FAILED)
                    .build(),
            ...
            Transfer.builder()
                    .id(8L)
                    .senderWallet(this.preparedWallets.get(4))
                    .recipientWallet(this.preparedWallets.get(2))
                    .amount(15L)
                    .status(TransferStatus.FAILED)
                    .build(),
            Transfer.builder()
